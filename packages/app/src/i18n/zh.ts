...
export const dict = {
  ...
  "settings.general.row.sessionWidth.title": "会话宽度",
  "settings.general.row.sessionWidth.description": "选择桌面端会话时间线与输入区的宽度",
  "settings.general.row.sessionWidth.option.narrow": "窄",
  "settings.general.row.sessionWidth.option.wide": "宽",
  "settings.general.row.sessionWidth.option.auto": "自适应",
  ...
  "sound.option.custom": "自定义",
  "sound.custom.clear": "移除自定义音效",
  "sound.custom.invalidType": "无效的文件类型",
  "sound.custom.invalidTypeDescription": "请选择有效的音频文件（WAV、MP3、AAC、OGG 或 WebM）。",
  "sound.custom.tooLarge": "文件过大",
  "sound.custom.tooLargeDescription": "音频文件必须小于 2MB。",
  "sound.custom.readFailed": "无法读取文件",
  "sound.custom.readFailedDescription": "请尝试其他音频文件。",
