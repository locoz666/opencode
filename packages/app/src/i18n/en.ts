export const dict = {
  ...
  "settings.general.row.sessionWidth.title": "Session width",
  "settings.general.row.sessionWidth.description": "Choose how wide the session timeline and composer are on desktop",
  "settings.general.row.sessionWidth.option.narrow": "Narrow",
  "settings.general.row.sessionWidth.option.wide": "Wide",
  "settings.general.row.sessionWidth.option.auto": "Auto",
